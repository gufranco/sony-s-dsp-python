...
**8** voices, **240** cases from real game configurations, **0** failures, **15,360** samples cross-checked, **97** of **104** checks taken on a console agree, every rate, attack time and register address held to Nintendo's own tables, **602** tests, **100%** statement and branch coverage, no dependencies
